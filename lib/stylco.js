module.exports = function (debug) {
    ...
    Stylco.prototype.create = function (destination, extend_from) {
        ...
        try {
            fs.mkdirRecursiveSync(destination_dir);
        ...
        if (_config.append_to_buildfile) {
            ...
            if (_config.allow_buildfile_outside_basedir || !_isPathOutsideDir(_config.basedir, buildfile_path)) {
                ...
                buildfile_line = this._getImportLine(path.join(path.parse(buildfile_path)['name'], component_name));
    ...
    Stylco.prototype._getFileContent = function (component_name, file_id, extend_from_relative) {
        ...
        if (imports && (imports instanceof Array)) {
     ...
     * @param import_path Path to component
     * @returns {string}
     * @private
     */
    Stylco.prototype._getImportLine = function (import_path) {
        var _config = this._config;
        import_path = _unixSlashesPath(import_path);
        if (_config.import_with_ext) {
    ...
    Stylco.prototype._init = function (debug) {
        ...
        if ((typeof _config.file_write_options === 'object') && (typeof _config.file_write_options.mode === 'string')) {
     ...
     * @property {{string: StylcoConfigFileItem}} files
     */
     ...
     * @param {{string: string}} values Name-value dictionary; name should be provided WITHOUT curly braces
     * @returns {string}
     * @private
     */
